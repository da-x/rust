...
pub fn expand_line(cx: &mut ExtCtxt,
                   _path: &Option<::ast::Path>, sp: Span, tts: &[tokenstream::TokenTree])
...
pub fn expand_column(cx: &mut ExtCtxt, _path: &Option<::ast::Path>, sp: Span, tts: &[tokenstream::TokenTree])
                  -> Box<dyn base::MacResult+'static> {
...
pub fn expand_column_gated(cx: &mut ExtCtxt, path: &Option<::ast::Path>, sp: Span, tts: &[tokenstream::TokenTree])
                  -> Box<dyn base::MacResult+'static> {
...
/// out if we wanted.
pub fn expand_file(cx: &mut ExtCtxt, _path: &Option<::ast::Path>, sp: Span, tts: &[tokenstream::TokenTree])
                   -> Box<dyn base::MacResult+'static> {
...
pub fn expand_stringify(cx: &mut ExtCtxt, _path: &Option<::ast::Path>, sp: Span, tts: &[tokenstream::TokenTree])
                        -> Box<dyn base::MacResult+'static> {
    let s = pprust::tts_to_string(tts);
    base::MacEager::expr(cx.expr_str(sp, Symbol::intern(&s)))
}

pub fn expand_mod(cx: &mut ExtCtxt, _path: &Option<::ast::Path>,
                  sp: Span, tts: &[tokenstream::TokenTree])
                  -> Box<dyn base::MacResult+'static> {
...
/// unhygienically.
pub fn expand_include<'cx>(cx: &'cx mut ExtCtxt, _path: &Option<::ast::Path>,
                           sp: Span, tts: &[tokenstream::TokenTree])
...
pub fn expand_include_str(cx: &mut ExtCtxt, _path: &Option<::ast::Path>,
                          sp: Span, tts: &[tokenstream::TokenTree])
                          -> Box<dyn base::MacResult+'static> {
...
pub fn expand_include_bytes(cx: &mut ExtCtxt, _path: &Option<::ast::Path>,
                            sp: Span, tts: &[tokenstream::TokenTree])
                            -> Box<dyn base::MacResult+'static> {
